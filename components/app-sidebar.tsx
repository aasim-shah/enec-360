...
const menu = [
  ...
  { title: "Videos", path: "/dashboard/videos", icon: FileText },
  { title: "Languages", path: "/dashboard/languages", icon: Languages },
];
          ...
          <SidebarMenu>
            {menu.map((item) => (
              <SidebarMenuItem key={item.title}>
                <Link href={item.path}>
                  <SidebarMenuButton isActive={isMenuActive(item.path)}>
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <div
                ...
                className="w-full flex cursor-pointer hover:bg-secondary p-2 flex-wrap items-center gap-3 transition-all duration-300 ease-in-out"
              >
